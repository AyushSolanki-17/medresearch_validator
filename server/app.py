...
"""
FastAPI application for the Medresearch Validator Environment.

This module creates an HTTP server that exposes the MedresearchValidatorEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m medresearch_validator.server.app
    ...
    multiple workers:
        uvicorn medresearch_validator.server.app:app --workers 4
    """
    import uvicorn
